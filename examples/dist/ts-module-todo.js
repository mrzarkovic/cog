...
/***/ "./examples/src/ts-module-todo.ts":
/*!****************************************!*\
  !*** ./examples/src/ts-module-todo.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_cog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/cog */ \"./src/cog.ts\");\n\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  (0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.render)(document.getElementById(\"app\"));\n});\nconst todos = (0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.variable)(\"todos\", [{\n  text: \"hello\",\n  done: false\n}]);\n(0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.variable)(\"save\", () => {\n  const todo = document.querySelector(\"[data-input=todo\");\n  if (todo?.value) {\n    todos.set([...todos.value, {\n      text: todo.value,\n      done: false\n    }]);\n    todo.value = \"\";\n  }\n});\n(0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.variable)(\"toggleTodo\", index => {\n  const newTodos = [...todos.value];\n  newTodos[index].done = !newTodos[index].done;\n  todos.set(newTodos);\n});\n(0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.variable)(\"Checkbox\", _ref => {\n  let {\n    index = -1,\n    checked = false\n  } = _ref;\n  return `<input type=\"checkbox\" id=\"todo${index}\" data-on-change=\"toggleTodo(${index})\" ${checked ? \"checked\" : \"\"} />`;\n});\nconst counter = (0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.variable)(\"counter\", 0);\n(0,_src_cog__WEBPACK_IMPORTED_MODULE_0__.variable)(\"increment\", () => {\n  counter.set(counter.value + 1);\n});\n\n//# sourceURL=webpack://@mzrk/cog/./examples/src/ts-module-todo.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   evaluateTemplate: () => (/* binding */ evaluateTemplate),\n/* harmony export */   extractTemplateExpressions: () => (/* binding */ extractTemplateExpressions)\n/* harmony export */ });\n/* harmony import */ var _expressions_evaluateExpression__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../expressions/evaluateExpression */ \"./src/expressions/evaluateExpression.ts\");\n/* harmony import */ var _findNextTemplateExpression__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./findNextTemplateExpression */ \"./src/html/findNextTemplateExpression.ts\");\n/* harmony import */ var _htmlToText__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./htmlToText */ \"./src/html/htmlToText.ts\");\n/* harmony import */ var _expressions_sanitizeExpression__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../expressions/sanitizeExpression */ \"./src/expressions/sanitizeExpression.ts\");\n/* harmony import */ var _expressions_createExpressionScope__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../expressions/createExpressionScope */ \"./src/expressions/createExpressionScope.ts\");\n/* harmony import */ var _html_removeTagsAndAttributeNames__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../html/removeTagsAndAttributeNames */ \"./src/html/removeTagsAndAttributeNames.ts\");\n\n\n\n\n\n\nconst evaluateTemplate = function evaluateTemplate(template, expressions, state) {\n  let stateChanges = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];\n  let restOfContent = template;\n  let updatedContent = \"\";\n  for (let i = 0; i < expressions.length; i++) {\n    const {\n      start,\n      end,\n      value\n    } = expressions[i];\n    const before = restOfContent.slice(0, start);\n    const after = restOfContent.slice(end + 1);\n    let evaluated = expressions[i].evaluated;\n    const intersection = expressions[i].dependencies.filter(value => stateChanges.includes(value));\n    if (intersection.length || evaluated === null) {\n      const expressionWithScope = (0,_expressions_createExpressionScope__WEBPACK_IMPORTED_MODULE_4__.createExpressionScope)(value, state);\n      evaluated = (0,_expressions_evaluateExpression__WEBPACK_IMPORTED_MODULE_0__.evaluateExpression)(expressionWithScope, state);\n      expressions[i].evaluated = evaluated;\n    }\n    updatedContent += `${before}${evaluated}`;\n    restOfContent = after;\n  }\n  updatedContent += restOfContent;\n  return updatedContent;\n};\n\n/**\n * Extracts all template expressions from a template string.\n * start and end are relative to the last template expression.\n */\nconst extractTemplateExpressions = (template, state) => {\n  const expressions = [];\n  let restOfContent = String(template);\n  let hasTemplateExpression = true;\n  while (hasTemplateExpression) {\n    const {\n      start,\n      end\n    } = (0,_findNextTemplateExpression__WEBPACK_IMPORTED_MODULE_1__.findNextTemplateExpression)(restOfContent);\n    if (end === -1) {\n      hasTemplateExpression = false;\n      break;\n    }\n    const htmlValue = restOfContent.slice(start + 2, end - 1);\n    const after = restOfContent.slice(end + 1);\n    const value = (0,_expressions_sanitizeExpression__WEBPACK_IMPORTED_MODULE_3__.sanitizeExpression)((0,_htmlToText__WEBPACK_IMPORTED_MODULE_2__.htmlToText)(htmlValue));\n    const uniqueIndex = {};\n    const dependencies = new Set();\n    (0,_html_removeTagsAndAttributeNames__WEBPACK_IMPORTED_MODULE_5__.removeTagsAndAttributeNames)(value).split(\"@\").filter(wordFromExpression => uniqueIndex[wordFromExpression] ? false : uniqueIndex[wordFromExpression] = true).filter(wordFromExpression => state[wordFromExpression]).forEach(dependency => {\n      if (state[dependency].dependencies.length) {\n        state[dependency].dependencies.forEach(dep => dependencies.add(dep));\n      } else {\n        dependencies.add(dependency);\n      }\n    });\n    expressions.push({\n      start,\n      end,\n      value,\n      dependencies: Array.from(dependencies),\n      evaluated: null\n    });\n    restOfContent = after;\n  }\n  return expressions;\n};\n\n//# sourceURL=webpack://@mzrk/cog/./src/html/evaluateTemplate.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   sanitizeHtml: () => (/* binding */ sanitizeHtml)\n/* harmony export */ });\nconst sanitizeHtml = html => {\n  return html.replace(/[\\r\\n]+\\s*/g, \"\");\n};\n\n//# sourceURL=webpack://@mzrk/cog/./src/html/sanitizeHtml.ts?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./examples/src/ts-module-todo.ts");
/******/ 	
